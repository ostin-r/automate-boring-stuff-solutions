...
def validBoardCheck(board):
    ...
    return valid_board, message


board = {'h1': 'bking', 'c6': 'wqueen', 'h5': 'bqueen', 'e3': 'wking', 'a6':'bbishop', 'b6':'bbishop'}
validity, message = validBoardCheck(board)
